...
def topology (objects, options=False):
    ...
    each({"point":newPointFunc})
    def newLineFunc(line):
        i = 0
        n = len(line)
        while i < n:
    ...
    def newFeatureFunc (self,feature):
